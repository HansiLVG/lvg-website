...
(function () {
  ...
  style.textContent = `
    .wave-bg {
      ...
      z-index: 1;
      overflow: hidden;
      -webkit-mask-image: linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.80) 13.0%, rgba(0,0,0,0.00) 26.0%, rgba(0,0,0,0.00) 74.0%, rgba(0,0,0,0.80) 87.0%, rgba(0,0,0,1) 100%);
              mask-image: linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.80) 13.0%, rgba(0,0,0,0.00) 26.0%, rgba(0,0,0,0.00) 74.0%, rgba(0,0,0,0.80) 87.0%, rgba(0,0,0,1) 100%);
    }
