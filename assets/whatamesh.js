/* whatamesh - inlined Stripe WebGL mesh gradient.
   Source: https://gist.github.com/jordienr64bcf75f8b08641f205bd6a1a0d4ce1d
   Exposes window.Gradient.
*/
  (function () {
    ...
    function e(object, propertyName, val) {
      return propertyName in object ? Object.defineProperty(object, propertyName, { value: val, enumerable: !0, configurable: !0, writable: !0 }) : object[propertyName] = val, object;
    }
    ...
    class Gradient {
      ...
      disconnect() {
        this.scrollObserver && (window.removeEventListener("scroll", this.handleScroll), window.removeEventListener("mousedown", this.handleMouseDown), window.removeEventListener("mouseup", this.handleMouseUp), window.removeEventListener("keydown", this.handleKeyDown), this.scrollObserver.disconnect());
      ...
      init() {
        ...
        if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
          // Statisches Render: ein Frame, keine Animation
          this.mesh.material.uniforms.u_time.value = this.t;
          this.minigl.render();
